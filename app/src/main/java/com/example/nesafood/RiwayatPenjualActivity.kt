...
class RiwayatPenjualActivity : AppCompatActivity() {

    private val listRiwayat = mutableListOf<Pesanan>()
    private val listSemua = mutableListOf<Pesanan>() // backup semua data
    private lateinit var adapter: RiwayatAdapter
    private val baseUrl = "http://10.205.130.250/nesafood" // ganti sesuai IP kamu
    ...
    private fun ambilRiwayatPenjual() {
        ...
        val url = "$baseUrl/list_riwayat_penjual.php"
        ...
        val req = object : StringRequest(Method.POST, url,
                    ...
                    if (obj.optBoolean("success", false)) {
                        ...
                        for (i in 0 until arr.length()) {
                            ...
                            val pesanan = Pesanan(
                                ...
                                namaPembeli = o.optString("nama_pembeli", "-"),
            ...
            override fun getParams(): MutableMap<String, String> =
                hashMapOf("shop_username" to username)
        }
